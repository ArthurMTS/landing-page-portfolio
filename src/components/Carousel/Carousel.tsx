...
export const Carousel: React.FC<CarouselProps> = ({ children, width }) => {
  ...
  const onLeftChevronClick = () => updateIndex(activeIndex - 1);

  const onRightChevronClick = () => updateIndex(activeIndex + 1);
